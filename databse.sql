...
INSERT INTO `tbcliente` VALUES (2,'5','402220655','Maria corrales alpizar','1999-08-08',67803080,'cliente@gmail.com','Heredia, centro','M','2025-09-01','12345678',1),(8,NULL,'409880755','Cristian Carrillo','1997-08-17',87654532,'cristian@gmail.com','Heredia, sarapiqui','M','2025-08-05','12345678',1),(9,NULL,'406650369','Jefferson Carrillo','1994-08-10',84859630,'jeffcar@gmail.com','San José','M','2025-08-14','12345678',1),(15,NULL,'501020201','Casandra Lascurein','2000-10-02',84582632,'cassandra@gmail.com','heredia, centro','F','2025-09-01','12345678',1),(20,NULL,'785256398','Mario Gonzáles Corrales','2001-10-07',69656368,'ma.example@gmail.com','San jose centro','M','2025-10-07','12345678',0);
...
INSERT INTO `tbclientepadecimiento` VALUES (1,2,'9',NULL),(2,9,'14$10',NULL),(6,8,NULL,58),(7,15,'14',57);
...
CREATE TABLE `tbevento` (
  ...
  `tbeventotipo` varchar(20) NOT NULL DEFAULT 'abierto' COMMENT 'Tipos: abierto, privado, mixto',
...
INSERT INTO `tbevento` VALUES (1,2,'abierto','Zumba Grupal','fdsf','2025-10-07','08:00:00','09:00:00',15,1),(3,1,'privado','De prueba','','2025-10-07','06:00:00','10:00:00',15,1);
...
CREATE TABLE `tbhorariopersonal` (
  `tbhorariopersonalid` int DEFAULT NULL,
...
INSERT INTO `tbpadecimientodictamen` VALUES (57,'2025-09-22','Clinica Puerto Viejo','22'),(58,'2025-09-30','Clinica San Juan de Dios','23');
...
INSERT INTO `tbreservasala` VALUES (1,1,'2$5','2025-10-07','08:00:00','09:00:00'),(3,3,'1','2025-10-07','06:00:00','10:00:00');
...
INSERT INTO `tbsala` VALUES (1,'Sala Principal',100,1),(2,'Sala de Recepción',14,1),(4,'Sala de Yoga',25,1),(5,'Sala baile',40,0),(7,'Sala para cardio',90,1);
...
-- Dump completed on 2025-10-06 23:44:30
