...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2025 at 10:54 AM
...
CREATE TABLE `tbhorariopersonal` (
  `tbhorariopersonalid` int(11) DEFAULT NULL,
...
INSERT INTO `tbreservaevento` (`tbreservaeventoid`, `tbreservaeventoclienteid`, `tbreservaeventoeventoid`, `tbreservaeventofecha`, `tbreservaeventohorainicio`, `tbreservaeventohorafin`, `tbreservaeventoactivo`) VALUES
(1, 2, 1, '2025-09-25', '11:00:00', '13:00:00', 1);
...
INSERT INTO `tbreservalibre` (`tbreservalibreid`, `tbreservalibreclienteid`, `tbreservalibrehorariolibreid`, `tbreservalibreactivo`) VALUES
(14, 2, 4, 1),
(16, 2, 3, 1);
...
--
ALTER TABLE `tbevento`
  MODIFY `tbeventoid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbhorariolibre`
--
ALTER TABLE `tbhorariolibre`
  MODIFY `tbhorariolibreid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbreservaevento`
  MODIFY `tbreservaeventoid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbreservalibre`
--
ALTER TABLE `tbreservalibre`
  MODIFY `tbreservalibreid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbreservasala`
--
ALTER TABLE `tbreservasala`
  MODIFY `tbreservasalaid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
