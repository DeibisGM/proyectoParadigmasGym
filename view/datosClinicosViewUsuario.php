...
$clienteId = $_SESSION['usuario_id']; // Asumiendo que el ID del usuario está en la sesión
...
// Verificar si ya existen datos clínicos para este usuario
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Inicializar campos condicionales para el formulario de creación
            <?php if (!$tieneRegistro): ?>
