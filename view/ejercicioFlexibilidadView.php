...
<body>
    <div class="container">
        <header>
            ...
            <h2><i class="ph ph-person-simple-walk"></i> Gestión de Ejercicios de Flexibilidad</h2>
        </header>
                        ...
                        <div class="form-grid-container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="duracion" name="duracion"
                                    value="<?= Validation::getOldInput('duracion') ?>" min="1" placeholder="Ej: 30">
                            </div>
                            <div class="form-group">
                                <label for="series">Series:</label>
                                <?php if ($error = Validation::getError('series')): ?><span class="error-message">
                                        <?= $error ?>
                                    </span><?php endif; ?>
                                <input type="number" id="series" name="series"
                                    value="<?= Validation::getOldInput('series') ?>" min="1" placeholder="Ej: 3">
                            </div>
                            <div class="form-group">
                                <label for="equipodeayuda">Equipo de Ayuda:</label>
                                <?php if ($error = Validation::getError('equipodeayuda')): ?><span class="error-message">
                                        <?= $error ?>
                                    </span><?php endif; ?>
                                <input type="text" id="equipodeayuda" name="equipodeayuda" maxlength="200"
                                    value="<?= Validation::getOldInput('equipodeayuda') ?>"
                                    placeholder="Ej: Colchoneta, banda elástica">
                            </div>
                        </div>
                            ...
                            <?php foreach ($ejercicios as $ejer):
                                ...
                                <tr>
                                    <form id="form-<?= $idFila ?>" method="post"
                                        action="../action/ejercicioFlexibilidadAction.php"></form>
                                    ...
                                    <td data-label="Duración"><input type="text" name="duracion"
                                            value="<?= htmlspecialchars($ejer->getDuracion()) ?>"
                                            <?= $esAdminOInstructor ? '' : 'readonly' ?> form="form-<?= $idFila ?>">
                                    </td>
                                    <td data-label="Series"><input type="text" name="series"
                                            value="<?= htmlspecialchars($ejer->getSeries()) ?>"
                                            <?= $esAdminOInstructor ? '' : 'readonly' ?> form="form-<?= $idFila ?>">
                                    </td>
                                    <td data-label="Equipo"><input type="text" name="equipodeayuda"
                                            value="<?= htmlspecialchars($ejer->getEquipodeayuda()) ?>"
                                            <?= $esAdminOInstructor ? '' : 'readonly' ?> form="form-<?= $idFila ?>">
                                    </td>
